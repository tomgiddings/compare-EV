      ...
      <header className="bg-gradient-to-r from-purple-900 to-purple-500 border-gray-200 shadow-2xl mb-10">
        <nav className="container mx-auto text-white py-3 flex space-x-4 items-end">
          <div className="w-32 my-3 min-h-fit">
            ...
            y="0px" viewBox="0 0 621 326" enable-background="new 0 0 621 326" xmlSpace="preserve">
              <g id="parts">
                
                  <path fill="none" stroke={logoColor} stroke-width="16.5789" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                  ...
                  <line fill="none" stroke={logoColor} stroke-width="16.5789" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="443.282" y1="285.368" x2="303.743" y2="283.987"/>
                
                  <path fill="none" stroke={logoColor} stroke-width="15.211" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
                ...
                <g>
                    ...
                    <line fill="none" stroke={logoColor} stroke-width="15.211" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="30.191" y1="39.448" x2="11.54" y2="39.448"/>
                  
                    <line fill="none" stroke={logoColor} stroke-width="15.211" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="30.191" y1="62.244" x2="11.54" y2="62.244"/>
                </g>
              </g>
            </svg>
          </div>
